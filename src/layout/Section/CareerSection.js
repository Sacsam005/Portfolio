  ...
  return (
    <>
      <section className="career_highlights_section mt-5">
        ...
        >
          <div className="career_section_wrapper wrapper_1 p-2">
            ...
            <div className="career_section_text">
              <h2
                ...
                `}
              >
                Web development | UI/UX and Design Thinking
              </h2>
        ...
        <motion.div
          ...
          variants={slideUpVariants}
        >
          <div className="career_section_wrapper wrapper_2 p-2">
            <div className="career_section_text">
              <h2
                className={`px-3 py-2
                  darkMode
                ...
                <div className="popup_text standard_text mt-4">
                  <ul>
                    ...
                    <li>
                      ...
                      in 512px customer satisfaction.
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <motion.div
          ...
          variants={slideUpVariants}
        >
          <div className="career_section_wrapper wrapper_3 p-2">
            <div className="career_section_image">
              <img
            ...
            <div className="career_section_text">
              <h2
                ...
                `}
              >
                SharePoint Admin w/Custom Development Experience
              </h2>
