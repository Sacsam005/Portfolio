        ...
        <>
            <section className="career_highlights_section mt-5">
                ...
                >
                    <div className="career_section_wrapper wrapper_1">
                        ...
                        <div className="career_section_text">
                            ...
                            <ul className="standard_text mb-1">
                                <li>
                                    Developed responsive and seamless frontend
                                    UIs with elegant user experience.
                                </li>
                                <li>
                                    Constructed designs for Mobile apps/products
                                    from scratch alongside w/wireframes &
                                    animated prototypes.
                                </li>
                                <li>
                                    Created high fidelity mockups for all sized
                                    devices.
                                </li>
                                ...
                                <div className="popup_text standard_text mt-4">
                                    <ul>
                                        <li>
                                            ...
                                            single-page web applications (SPA)s
                                            w/React for e-commerce and small
                                            businesses (internal/external
                                            purposes) assuring engaging user
                                            experience and responsive web
                                            design.
                                        </li>
                                        <li>
                                            Developed user interfaces utilizing
                                            fetch API using react, material UI
                                            w/several other libraries, tools and
                                            dependencies sprinkled to minify the
                                            frontend code. Worked with Search
                                            Engine optimization (SEOs), secured
                                            JSON & APIs. Working knowledge of
                                            current industry patterns and best
                                            practices
                                        </li>
                                        <li>
                                            Collaborated with fellow developers
                                            and engineers for code reviews,
                                            bug-fixes, creating design mockups
                                            and wireframes. Provided
                                            after-launch support for internal
                                            and external web applications and
                                            reduced any client downtime by 50%.
                                        </li>
                                        <li>
                                            Ensured efficient web development by
                                            supporting designers and developers
                                            while maintaining website and
                ...
                <motion.div
                    ...
                    variants={slideUpVariants}
                >
                    <div className="career_section_wrapper wrapper_2">
                        <div className="career_section_text">
                            <h2 className="px-3 py-2">
                                Software Ecosystem Exposure
                            </h2>

                            <ul className="standard_text mb-1">
                                <li>
                                    Partnered with a cross-functional agile team
                                    to develop and maintain websites and
                                    applications for healthcare and e-commerce
                                    sectors.
                                </li>
                            </ul>

                            <div
                                className="skill_labels_div p-2 m-0 list-unstyled"
                                style={{ fontSize: "1rem" }}
                            >
                                <h3 className="standard_text m-2">
                                    Also familiar with
                                </h3>

                                {skills.map((skill, index) => (
                                    <span key={index} className="skill_span">
                                        {skill}
                                    </span>
                                ))}
                            </div>
                            ...
                            >
                                ...
                                <div className="popup_text standard_text mt-4">
                                    <ul>
                                        <li>
                                            Overall exposure to a wide variety
                                            of software ecosystem - DevOps,
                                            ServiceNow, UiPath Studio, Mobile
                                            testing automation using UiPath
                                            Studio (iOS and Android), Postman,
                                            Swagger.
                                        </li>
                                        <li>
                                            Tested healthcare
                                            software/applications, identified
                                            bugs and communicated defects to
                                            Developers, documented/wrote manual
                                            testing steps for quality assurance
                                            purposes; executing tests and
                                            analyzing results. Performed
                                            database schema testing...
                                        </li>
                                        <li>
                                            Exposure to feature updates in
                                            existing products targeted at
                                            improving operational efficiency
                                            while also maintaining scalability.
                                        </li>
                                        <li>
                                            Worked closely with external
                                            stakeholders to identify and address
                                            issues that impacted daily
                                            operations. Partenered with
                                            cross-functional teams to ensure
                                            seamless alignment between business
                                            needs and product requirements,
                                            resulting in 100% customer
                                            satisfaction.
                                        </li>
                                        <li>
                                            Knowledge of collaboration, Project
                                            Lifecycle / Software Development
                                            Life Cycle (SDLC) and familiar with
                                            CI/CD.
                                        </li>
                                    </ul>
                                </div>
                ...
                >
                    <div className="career_section_wrapper wrapper_3">
                        ...
                        <div className="career_section_text">
                            ...
                            <ul className="standard_text mb-1">
                                <li>
                                    Overall exposure to different aspect of the
                                    development including SharePoint custom
                                    development using SharePoint Framework
                                    (SPFx).
                                </li>
                                <li>
                                    Had an exposure to TypeScript | MicroSoft
                                    Graph API & SharePoint Restful API | several
                                    development toolchains such as gulp-cli,
                                    yeoman, pnp-spfx, Webpack (.sppkg), which I
                                    consider as a massive boosting to my career.
                                </li>
                            </ul>
                            ...
                            >
                                ...
                                <div className="popup_text standard_text mt-4">
                                    <ul>
                                        <li>
                                            Hands-on experience on developing
                                            and deploying OOTB SharePoint
                                            components such as custom -
                                            webparts, extensions, solutions.
                                            Worked simultaneously on multiple
                                            servers with different versions of
                                            build toolchain dependencies, by
                                            taking full ownership to develop,
                                            test and ship custom web solutions
                                            w/o any conflict. Created technical
                                            and user documentation for the
                                            shipped products.
                                        </li>
                                        <li>
                                            Integrated SharePoint platform with
                                            other Microsoft products and
                                            third-party solutions and ensured
                                            their joint operation without
                                            business processes interruption.
                                            Migrated contents to SharePoint
                                            Online and On-Premise intranets
                                            using Sharegate.
                                        </li>
                                        <li>
                                            Implemented feature enhancements and
                                            troubleshooting procedures
                                            understanding customer concerns.
                                            Developed, Integrated, and
                                            Maintained SharePoint Solutions for
                                            Optimal Business Performance.
                                        </li>
                                        <li>
                                            Collaborated closely with other
                                            stakeholders to translate business
                                            needs and product requirements into
                                            innovative solutions for customers.
                                            Revamped multiple sites offering
